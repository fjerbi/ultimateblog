    ...
    <div class="menu">
        <ul class="list">
            ...
            @if(Request::is('admin*'))
                ...
                <li class="{{ Request::is('admin/pending/story') ? 'active' : '' }}">
                    <a href="{{ route('admin.story.pending') }}">
                        <i class="material-icons">library_books</i>
            ...
            @if(Request::is('author*'))
                ...
                <li class="{{ Request::is('author/story*') ? 'active' : '' }}">
                    <a href="{{ route('author.story.index') }}">
                        <i class="material-icons">library_books</i>
                        <span>Posts</span>
                    </a>
                </li>
    ...
    <div class="legal">
        <div class="copyright">
            ...
            <strong> Developed &amp; <i class="far fa-heart"></i> by </strong>
                        <a href="https://www.youtube.com/channel/UCwbVAlvrsD2Tpx93bleNbOA" target="_blank">Developers365</a>.
        </div>
        <div class="version">
            <b>Version: </b> 1.0.5
        </div>
