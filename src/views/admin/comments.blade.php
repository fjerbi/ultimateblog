                                            ...
                                            <td>
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p>{{ $comment->comment }}</p>
                                                        <a target="_blank" href="{{ route('story.details',$comment->story->slug.'#comments') }}">Reply</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="media">
                                                    <div class="media-right">
                                                        <a target="_blank" href="{{ route('story.details',$comment->story->slug) }}">
                                                            <img class="media-object" src="{{ Storage::disk('public')->url('story/'.$comment->story->image) }}" width="64" height="64">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <a target="_blank" href="{{ route('story.details',$comment->story->slug) }}">
                                                            <h4 class="media-heading">{{ str_limit($comment->story->title,'40') }}</h4>
                                                        </a>
                                                        <p>by <strong>{{ $comment->story->user->name }}</strong></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
