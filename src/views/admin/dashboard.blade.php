        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-green hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">TOTAL STORIES</div>
                        <div class="number count-to" data-from="0" data-to="{{ $stories->count() }}" data-speed="15" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-cyan hover-expand-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="{{ Auth::user() ->favorite_stories()->count() }}" data-speed="1000" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-red hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">PENDING STORIES</div>
                        <div class="number count-to" data-from="0" data-to="{{ $total_pending_stories }}" data-speed="1000" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-hover dashboard-task-infos">
                                ...
                                <tbody>
                                    @foreach($popular_stories as $key=>$story)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $story->title }}</td>
                                            <td>{{ $story->user->name }}</td>
                                            <td>{{ $story->view_count }}</td>
                                            <td>{{ $story->favorite_to_users_count }}</td>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-primary waves-effect" target="_blank" href="{{ route('story.details',$story->slug) }}">View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                ...
                                <tbody>
                                    @foreach($active_authors as $key=>$author)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $author->name }}</td>
                                            <td>{{ $author->stories_count }}</td>
                                            <td>{{ $author->comments_count }}</td>
                                            <td>{{ $author->favorite_stories_count }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
